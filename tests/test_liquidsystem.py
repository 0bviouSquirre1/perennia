...
class TestLiquidSystem(BaseEvenniaTest):
    ...
    def test_liquid_container(self):
        ...
        assert container.db.fill_level == 50, f"fill_level are {container.db.fill_level}"
    ...
    def test_transfer_in_bounds(self):
        ...
        assert self.well.db.fill_level == 40, f"actually {self.well.db.fill_level}"
        assert self.kettle.db.fill_level == 60, f"actually {self.kettle.db.fill_level}"
